 ...
 */
public class SortedNoNegSinglyLinkedList {
    private Node head = null;
    private int size = 0;
    public SortedNoNegSinglyLinkedList() {
    }

    public SortedNoNegSinglyLinkedList(ArrayList<Integer> list){
        for (int n: list) {
            add(n);
        }
    }
    public SortedNoNegSinglyLinkedList(int[] a){
        for (int n: a
             ) {
            add(n);
        }
